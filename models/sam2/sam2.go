...
//   - internalStates: Struct containing intermediate states and predictions (e.g. IoUScores for Intersection over Union, FPNHiddenStates for Feature Pyramid Network) that are
